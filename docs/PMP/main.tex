...
En términos de desarrollo colaborativo, el proyecto utiliza \textbf{Git} y \textbf{GitHub} para control de versiones, gestión de ramas y revisión de cambios, complementados con el \textbf{tablero Kanban proporcionado por el departamento} como herramienta de seguimiento de tareas acorde con la dinámica iterativa definida en la metodología del proyecto.
