...
El presente documento constituye el Plan de Administración de Proyecto (PMP) de \textbf{GammaLab 2.0}, la versión extendida de la plataforma de código abierto para el análisis y visualización de señales electroencefalográficas (EEG) desarrollada originalmente como GammaLab 1.0. Su propósito es documentar de forma estructurada la planificación, la organización y los mecanismos de control que rigen el desarrollo del proyecto, permitiendo al lector comprender la justificación, el alcance y la estrategia metodológica adoptada para su ejecución.

GammaLab 2.0 surge como respuesta a las brechas técnicas y funcionales identificadas en la primera versión del sistema, con el propósito de ampliar sus capacidades de análisis, fortalecer su arquitectura y mejorar la experiencia de usuario, manteniendo la filosofía de software libre que ha caracterizado al proyecto desde su origen.

Este documento expone de forma estructurada la vista general del proyecto, el contexto metodológico y tecnológico adoptado, los mecanismos de administración y control, y los procesos de soporte que acompañan el desarrollo. La metodología adoptada combina un enfoque secuencial por fases (\textit{Water-Scrum-Fall}) con ciclos iterativos de trabajo al interior de cada una, permitiendo mantener trazabilidad sobre las dependencias técnicas del proyecto sin renunciar a la flexibilidad frente a cambios.

El documento está dirigido a los integrantes del equipo de desarrollo, a la directora del proyecto, a los revisores académicos del trabajo de grado y al Laboratorio de Electrofisiología de la Universidad Nacional de Colombia, como cliente y usuario final del sistema. Su lectura es especialmente útil para comprender la planificación formal y estratégica detrás del desarrollo de GammaLab 2.0, así como los criterios bajo los cuales se medirá su éxito.
...
La siguiente tabla sintetiza las características principales del proyecto GammaLab 2.0:
...
\caption{Acrónimos y términos utilizados en el documento}
\label{tab:acronimos} \\

\hline
\textbf{Sigla / Término} & \textbf{Definición} \\
\hline
\endfirsthead
...
SAD & \textit{Software Architecture Document}. Documento de arquitectura del sistema. \\
\hline

SRS & \textit{Software Requirements Specification}. Documento de especificación de requisitos. \\
\hline

SDD & \textit{Software Design Document}. Documento de diseño técnico. \\
\hline

IoC & Inversión de Control. Principio que delega el flujo de ejecución a un contenedor. \\
\hline

DI & \textit{Dependency Injection}. Técnica para resolver dependencias desde un contenedor externo. \\
\hline

MVP / MVC & Patrones de separación de interfaz y lógica (\textit{Model--View--Presenter} / \textit{Model--View--Controller}). \\
\hline
...
Python & Lenguaje de programación principal de \textit{Gamma Lab}. \\
\hline

PyQt5 & Framework de interfaz gráfica basado en Qt para Python. \\
\hline

VTK & \textit{Visualization Toolkit}. Biblioteca para visualización científica 2D/3D. \\
\hline
...
EDF & \textit{European Data Format}. Formato estándar para señales biomédicas. \\
\hline

ABF & \textit{Axon Binary File}. Formato de archivo utilizado por Axon Instruments para registros biomédicos. \\
\hline
...
\hline
Gestión del proyecto & Tablero Kanban (proporcionado por el departamento) \\
\hline
Documentación técnica & LaTex, Microsoft Word \\
\hline
Pruebas & Pytest \\
\hline
...
En términos de desarrollo colaborativo, el proyecto utiliza \textbf{GitHub} para control de versiones, gestión de ramas y revisión de cambios, complementados con el \textbf{tablero Kanban proporcionado por el departamento} como herramienta de seguimiento de tareas acorde con la dinámica iterativa definida en la metodología del proyecto.

La documentación técnica y académica se desarrolla principalmente en \textbf{LaTeX}, favoreciendo trazabilidad, edición colaborativa y consistencia de formato. Adicionalmente, se emplea \textbf{Microsoft Word} para documentación preliminar y trabajo colaborativo informal.
...
Finalmente, las pruebas de calidad se incorporan mediante \textbf{Pytest}, mientras que la coordinación del equipo se apoya en \textbf{Microsoft Teams} y \textbf{WhatsApp}. Como mecanismo de respaldo y pruebas compartidas, el proyecto cuenta adicionalmente con almacenamiento en \textbf{OneDrive} y una máquina virtual compartida.
...
\begin{itemize}[label={}]
    \item \textbf{VFP -- Versión Final de Proyecto.}
    Documento inicial que formaliza el problema, los objetivos, el alcance funcional y los lineamientos estratégicos y metodológicos del proyecto, sirviendo como base de referencia para la construcción del PMP y de los documentos técnicos posteriores.

    \item \textbf{PMP -- Plan de Administración del Proyecto.}
    Define los procesos de dirección del proyecto, la planificación y los mecanismos de seguimiento, estableciendo la estructura organizacional, los roles y el cronograma de trabajo.

    \item \textbf{MRCU -- Matriz de Requerimientos y Casos de Uso }
    Consolida la matriz original de requerimientos y casos de uso levantados durante la fase inicial del proyecto, registrando los históricos, conceptos, actores, requerimientos y cada caso de uso con su flujo principal y sus flujos alternos.

    \item \textbf{SRS -- Especificación de Requerimientos de Software.}
    Describe formalmente los requerimientos funcionales y no funcionales del sistema, formalizando las entradas, salidas, parámetros configurables y dependencias de cada módulo, incluyendo el nuevo módulo de análisis incorporado en GammaLab 2.0.

    \item \textbf{SAD -- Documento de Arquitectura de Software.}
    Formaliza las decisiones estructurales del sistema, incluyendo la distribución de componentes, las vistas arquitectónicas y la justificación técnica del diseño adoptado para GammaLab 2.0.

    \item \textbf{SDD -- Documento de Diseño de Software.}
    Presenta el diseño detallado de los componentes del sistema mediante diagramas de secuencia, diagramas de clases y demás representaciones estructurales, describiendo la organización modular y el comportamiento interno de GammaLab 2.0.

    \item \textbf{Mockups.}
    Incluye las representaciones visuales de alta fidelidad de la interfaz de GammaLab 2.0, en las que se plasman gráficamente las mejoras planteadas en la experiencia de usuario y la navegación intuitiva del sistema, utilizadas para validar la disposición general de los módulos y los flujos de navegación.

    \item \textbf{Repositorio Final.}
    ...
    \item \textbf{Informe de Pruebas y Validación.}
    ...
    \item \textbf{Memoria Final del Proyecto.}
...
\begin{itemize}
    ...
    \item Las metodologías de desarrollo (Water-Scrum-Fall) y las herramientas (Git, el Kanban del departamento, Python, PyQt5) permanecen estables durante la ejecución.
\end{itemize}
...
\begin{itemize}
    ...
    \item Familiarizarse con las tecnologías base (Python, PyQt5, VTK, etc.)
...
\begin{itemize}
    ...
    \item \textbf{Gestión del proyecto:} tablero Kanban proporcionado por el departamento, con columnas: ``To Do'', ``In Progress'', ``In Review'', ``Done''. Sincronización asíncrona diaria a través de comentarios en tarjetas de tareas.
...
formal del proyecto GammaLab 2.0.

\subsection{Administración de Requerimientos}

\subsubsection*{Descripción del proceso}

La administración de requerimientos en GammaLab 2.0 se concibe como un
...
\begin{itemize}
    ...
    \item \textbf{Tablero Kanban :} Muestra el estado del
...
Actualización del tablero Kanban & Todo el equipo & Diaria & Kanban del departamento \\ \hline

Verificación de velocidad del sprint &  Scrum Master & Semanal & Kanban del departamento \\ \hline
...
La entrega de GammaLab 2.0 alcliente se realizará durante la semana 17 del calendario
