...
\section{Introducci\'on}
    ...
    El presente Sodtware Design Document (SDD) tiene como prop\'osito describir la arquitectura y el dise\~no detallado del sistema Gamma Lab v2.0, incluyendo la estructura de sus componentes, la persistencia de datos, las relaciones entre los m\'odulos y la interfaz de usuario. 
    Este documento sirve como referencia para los desarrolladores, testers y otros miembros del equipo de proyecto, asegurando que todos comprendan la implementaci\'on t\'ecnica y funcional del sistema definida em el Software Architecture Document (SAD) y el Software Requirements Specification (SRS).


    \subsection{Alcance}
    El SDD abarca todos loas aspctos técnicos y de diseño del sistema necearios para su aplicación.
    \begin{itemize}
        \item Descripción de la arquitectura del sistema.
        \item Detalle de los componentes y módulos del sistema.
        \item Especificación de la persistencia de datos y modelos de datos.
        \item Definición de las relaciones entre los componentes.
        \item Descripción de la interfaz de usuario y su organización.
    \end{itemize}

    \subsection{Audiencia}
    La audiencia principal de este documento incluye:
    \begin{itemize}
        \item Desarrolladores de software: para comprender la estructura y el diseño del sistema.
        \item Testers: para validar la implementación del sistema según los requisitos.
        \item Directora de tesis: para supervisar el progreso y la coherencia del desarrollo.
        \item Stakeholders: para entender cómo se implementarán los requisitos funcionales y no funcionales.
    \end{itemize}
