...
class Ui_Wavelet_Average(object):
    def setupUi(self, Wavelet_Average):
        ...
        # Splitter to divide the areas into left (plot) and right (panel)
        self.splitter = QtWidgets.QSplitter(Wavelet_Average)
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName("splitter")
        self.mainWindow.addWidget(self.splitter)

        # Left area: Placeholder for Plot
        ...
        # ===== Header: Parameters + clear + Create Wavelet (always visible) =====
        ...
        self.createWaveletButton = QtWidgets.QPushButton(self.rightContainer)
        self.createWaveletButton.setObjectName("headerGenerateButton")
        self.headerLayout.addWidget(self.createWaveletButton)
        ...
        # Vertical layout for parameter controls
        ...
        self.retranslateUi(Wavelet_Average)
        QtCore.QMetaObject.connectSlotsByName(Wavelet_Average)

    def retranslateUi(self, Wavelet_Average):
        _translate = QtCore.QCoreApplication.translate
        Wavelet_Average.setWindowTitle(_translate("Wavelet_Average", "Wavelet_Average"))
        self.parametersLabel.setText(_translate("Wavelet_Average", "Parameters"))
        self.sampleDensityLabel.setText(_translate("Wavelet_Average", "Sample density"))
        self.hzLabel.setText(_translate("Wavelet_Average", "Hz"))
        self.rangeLabel.setText(_translate("Wavelet_Average", "Range"))
        self.frequencyLabel.setText(_translate("Wavelet_Average", "Frequency (Hz)"))
        self.highLabel.setText(_translate("Wavelet_Average", "High"))
        self.hzHighFreqLabel.setText(_translate("Wavelet_Average", "Hz"))
        self.lowLabel.setText(_translate("Wavelet_Average", "Low"))
        self.hzLowFreqLabel.setText(_translate("Wavelet_Average", "Hz"))
        self.waveletLabel.setText(_translate("Wavelet_Average", "Wavelet"))
        self.cyclesLabel.setText(_translate("Wavelet_Average", "Cycles"))
        self.scalogramLabel.setText(_translate("Wavelet_Average", "Scalogram"))
        self.normalizeLabel.setText(_translate("Wavelet_Average", "Normalize"))
        self.typeNormalizeLabel.setText(_translate("Wavelet_Average", "Type"))
        self.scaleLabel.setText(_translate("Wavelet_Average", "Scale"))
        self.typeScaleLabel.setText(_translate("Wavelet_Average", "Type"))
        self.createWaveletButton.setText(_translate("Wavelet_Average", "Generate"))
