...
class Ui_Fft_Average(object):
    def setupUi(self, FftAvg):
        ...
        # ===== Header: Parameters + clear + Calculate FFT Average (always visible) =====
        ...
        self.calculateFftAvgButton = QtWidgets.QPushButton(self.rightContainer)
        self.calculateFftAvgButton.setObjectName("headerGenerateButton")
        self.headerLayout.addWidget(self.calculateFftAvgButton)
    ...
    def retranslateUi(self, FftAvg):
        ...
        self.calculateFftAvgButton.setText(_translate("FftAvg", "Generate"))
